...
class AppLocalizations {
  ...
  // ==================== General ====================
  String get appName => _getString(AppStringsEn.companyName, AppStringsHi.companyName, AppStringsGu.companyName);
  ...
  String get autoSelected => _getString(AppStringsEn.autoSelected, AppStringsHi.autoSelected, AppStringsGu.autoSelected);
  ...
  String get paymentHistory => _getString(AppStringsEn.paymentHistory, AppStringsHi.paymentHistory, AppStringsGu.paymentHistory);
  String get addPayment => _getString(AppStringsEn.addPayment, AppStringsHi.addPayment, AppStringsGu.addPayment);
  String get paymentDate => _getString(AppStringsEn.paymentDate, AppStringsHi.paymentDate, AppStringsGu.paymentDate);
  String get paymentAmount => _getString(AppStringsEn.paymentAmount, AppStringsHi.paymentAmount, AppStringsGu.paymentAmount);
  String get paymentReceipts => _getString(AppStringsEn.paymentReceipts, AppStringsHi.paymentReceipts, AppStringsGu.paymentReceipts);
  String get noPaymentsYet => _getString(AppStringsEn.noPaymentsYet, AppStringsHi.noPaymentsYet, AppStringsGu.noPaymentsYet);
  String get deletePayment => _getString(AppStringsEn.deletePayment, AppStringsHi.deletePayment, AppStringsGu.deletePayment);
  String get deletePaymentConfirm => _getString(AppStringsEn.deletePaymentConfirm, AppStringsHi.deletePaymentConfirm, AppStringsGu.deletePaymentConfirm);
  String get advancePayment => _getString(AppStringsEn.advancePayment, AppStringsHi.advancePayment, AppStringsGu.advancePayment);
  String get fullyPaid => _getString(AppStringsEn.fullyPaid, AppStringsHi.fullyPaid, AppStringsGu.fullyPaid);
  ...
  // ==================== Transactions ====================
  String get transactions => _getString(AppStringsEn.transactions, AppStringsHi.transactions, AppStringsGu.transactions);
  String get transactionsSubtitle => _getString(AppStringsEn.transactionsSubtitle, AppStringsHi.transactionsSubtitle, AppStringsGu.transactionsSubtitle);
  String get clearFilter => _getString(AppStringsEn.clearFilter, AppStringsHi.clearFilter, AppStringsGu.clearFilter);
  String get totalIncome => _getString(AppStringsEn.totalIncome, AppStringsHi.totalIncome, AppStringsGu.totalIncome);
  String get totalExpense => _getString(AppStringsEn.totalExpense, AppStringsHi.totalExpense, AppStringsGu.totalExpense);
  String get noTransactions => _getString(AppStringsEn.noTransactions, AppStringsHi.noTransactions, AppStringsGu.noTransactions);
  String get noTransactionsDescription => _getString(AppStringsEn.noTransactionsDescription, AppStringsHi.noTransactionsDescription, AppStringsGu.noTransactionsDescription);
  String get today => _getString(AppStringsEn.today, AppStringsHi.today, AppStringsGu.today);
  String get yesterday => _getString(AppStringsEn.yesterday, AppStringsHi.yesterday, AppStringsGu.yesterday);
}
